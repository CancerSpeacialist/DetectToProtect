...
class LungCancerInference:
    def __init__(self, model_path):
        self.device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        self.model = LungCancerResNet50().to(self.device)
        ...
        self.class_labels = ["Healthy", "Nodule Detected"]
        self.class_mapping = {'Healthy': 0, 'Nodule Detected': 1}
    ...
    def predict(self, pil_image):
        ...
        try:
            ...
            with torch.no_grad():
                ...
                # Binary classification logic (using BCEWithLogitsLoss threshold)
            ...
            raise Exception(f"Error in lung cancer prediction: {str(e)}")