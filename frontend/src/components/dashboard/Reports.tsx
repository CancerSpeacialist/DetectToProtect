...
export function Reports() {
  ...
  const recentReports = [
    { id: 'R001', patient: 'John Doe', type: 'Comprehensive', date: '2024-01-15', status: 'completed' },
    { id: 'R002', patient: 'Sarah Wilson', type: 'Lab Results', date: '2024-01-14', status: 'completed' },
    { id: 'R003', patient: 'Mike Johnson', type: 'Imaging', date: '2024-01-12', status: 'pending' },
    { id: 'R004', patient: 'Emma Davis', type: 'Treatment Plan', date: '2024-01-10', status: 'completed' },
  ];
  ...
  const reportPreview = selectedPatient && reportType ? {
    title: `${reportTypes.find(r => r.value === reportType)?.label} - ${patients.find(p => p.id === selectedPatient)?.name}`,
    sections: [
            ...
            <CardContent>
              {!reportPreview ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">Select a patient and report type to see preview</p>
                </div>
              ) : (
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h3 className="font-medium text-blue-900">{reportPreview.title}</h3>
