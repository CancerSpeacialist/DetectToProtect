          ...
          <div className="hidden md:flex items-center space-x-6">
            <NavigationMenu>
              <NavigationMenuList>
                ...
                {/* Appointments Link */}
                <NavigationMenuItem>
                  <Link href="/patient/appointments" legacyBehavior passHref>
                    <NavigationMenuLink className="group bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 inline-flex h-10 w-max items-center justify-center rounded-md">
                ...
                {/* Reports Link */}
                <NavigationMenuItem>
                  <Link href="/patient/reports" legacyBehavior passHref>
